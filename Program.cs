...
namespace Homework5
{
//Джо Халдон. Создать программу, которая будет проверять корректность ввода логина.
...
//   б) ** с использованием регулярных выражений.
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Джо Халдон. Создать программу, которая будет проверять корректность ввода логина.\n " +
